...
const RueckerstattungBestaetigung = () => {
  ...
  return (
    <RueckerstattungWizardShell step={3}>
      <div className="text-center">
        ...
        >
          Rückerstattung erfolgreich übermittelt
        </h1>
        <p className="text-[14.5px] text-gray-600 max-w-md mx-auto leading-relaxed">
          Ihre Daten wurden erfolgreich übermittelt und werden geprüft. Der Betrag
          wird in Kürze auf das angegebene Konto überwiesen.
        </p>
      </div>
      ...
      <div className="mt-6 rounded-md bg-[#ecfdf5] border border-[#a7f3d0] px-4 py-3">
        <p className="text-[13px] text-[#065f46] leading-relaxed">
          <strong>Hinweis:</strong> Sie erhalten in Kürze eine Bestätigung per
          E-Mail. Es sind keine weiteren Schritte erforderlich.
        </p>
      </div>
...
export default RueckerstattungBestaetigung;
