              ...
              <div className="py-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-y-4 md:gap-x-6 items-center">
                  ...
                  <input
                    ...
                    className="md:col-span-2 w-full px-3 py-2.5 bg-white border rounded-[2px] text-[15px] outline-none transition-shadow focus:shadow-[0_0_10px_2px_rgba(0,0,0,0.35)]"
