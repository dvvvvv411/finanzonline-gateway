    ...
    <>
      ...
      <div className="min-h-screen bg-white flex flex-col">
        <div className="flex-1">
          <div className="max-w-[1100px] mx-auto px-10 md:px-20 pt-6 md:pt-10">
            ...
            {/* Headline */}
            <h1
              className="mt-10 text-[24px] md:text-[28px] font-normal"
              style={{ color: GREEN }}
            >
              {t.loginTitle}
            </h1>
        ...
        <footer className="mt-16 py-6">
          <div className="max-w-[1100px] mx-auto px-10 md:px-20">
            <div className="flex flex-wrap items-center gap-x-2 gap-y-2 text-[15px]" style={{ color: "#6c6e70" }}>
