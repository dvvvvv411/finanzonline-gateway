...
const Bawag = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#f0f0f0]" style={{ fontFamily: "'Segoe UI', Tahoma, Geneva, Verdana, sans-serif" }}>
      ...
      {/* Main Content */}
      <main className="flex-1 px-4 md:px-8 py-6 max-w-[1200px] mx-auto w-full">
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="flex-1 flex flex-col gap-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-gray-200">
                ...
                <div className="p-5">
                  ...
                  <ul className="space-y-2">
                    <li>
                      <a href="#" className="text-xs text-[#c20016] hover:underline flex items-center gap-1">
            ...
            <div className="rounded shadow-sm overflow-hidden">
              <img src={bawagBg} alt="BAWAG Kampagne" className="w-full h-auto" />
            </div>
          </div>
        </div>
      </main>
